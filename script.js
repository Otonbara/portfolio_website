...
document.addEventListener('mousemove', (event) => {
    const gokuIcon = document.querySelector('.goku-icon');
    gokuIcon.style.display = 'block'; // Show the icon when moving the mouse
    gokuIcon.style.left = `${event.pageX}px`;
    gokuIcon.style.top = `${event.pageY}px`;
});
